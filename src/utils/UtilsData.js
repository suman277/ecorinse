    ...
    categoryDetail: [
      {
        ...
        items: [
          { id: 1, item_name: "Wash & Fold", unit_price: 70, unit: "kg" },
    ...
    categoryDetail: [
      {
        ...
        items: [
          { id: 3, item_name: "Shirt", unit_price: 80, unit: "piece" },
          { id: 4, item_name: "Pant", unit_price: 80, unit: "piece" },
          ...
          { id: 12, item_name: "Coat", unit_price: 200, unit: "piece" },
        ],
      },
      {
